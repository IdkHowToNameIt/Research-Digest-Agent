...
(function () {
  ...
  var CELL = 46;                   // passo della griglia (px)
  var DENSITY = 0.30;              // frazione di celle con un glifo -> sparsi
  var DRAW = 0.60;                 // dimensione del glifo rispetto alla cella
  var RANGE_CELLS = 3.6;           // raggio d'influenza del cursore (in celle)
  ...
  window.addEventListener('mouseout', function (e) { if (!e.relatedTarget) mouse.on = false; });
